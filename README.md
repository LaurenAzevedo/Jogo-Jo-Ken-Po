...
O **Jogo Jo Ken Po** permite ao usuário escolher jogadas e realizar partidas contra o app. 
...
1. Clone este repositório:
    ...
    ```bash
    git clone https://github.com/LaurenAzevedo/Jogo-Jo-Ken-Po.git
...
[![NPM](https://img.shields.io/npm/l/react)](https://github.com/LaurenAzevedo/Jogo-Jo-Ken-Po/blob/main/LICENSE)
